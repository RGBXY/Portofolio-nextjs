...
const content = [
  {
    ...
    content: <Image height={200} width={200} alt="asb" src="/assets/about_1.jpg" className="object-cover h-full w-full bg-[linear-gradient(to_bottom_right,var(--cyan-500),var(--emerald-500))] flex items-center justify-center text-white" />,
  },
  {
    ...
    content: <Image height={200} width={200} alt="asb" src="/assets/about_2.png" className="object-cover h-full w-full bg-[linear-gradient(to_bottom_right,var(--cyan-500),var(--emerald-500))] flex items-center justify-center text-white" />,
  },
  {
    ...
    content: <Image height={200} width={200} alt="asb" src="/assets/about_3.jpg" className="object-cover h-full w-full bg-[linear-gradient(to_bottom_right,var(--cyan-500),var(--emerald-500))] flex items-center justify-center text-white" />,
  },
  {
    ...
    content: <Image height={200} width={200} alt="asb" src="/assets/about_5.jpg" className="object-cover h-full w-full bg-[linear-gradient(to_bottom_right,var(--cyan-500),var(--emerald-500))] flex items-center justify-center text-white" />,
  },
];
