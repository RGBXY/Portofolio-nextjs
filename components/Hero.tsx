...
const Hero = () => {
  return (
    <div className="h-[50rem] lg:h-screen flex justify-center items-center gap-12 relative">
      <div className="h-full pt-7 lg:pt-20 absolute w-full dark:bg-black bg-white dark:bg-grid-white/[0.08] bg-grid-black/[0.02] flex items-center justify-center flex-col-reverse md:flex-row md:gap-12">
